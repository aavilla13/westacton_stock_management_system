...
<form action="<?php echo htmlspecialchars('/westacton_management_system/controller/view_product.php?id=' . $id);?>" method="post" style="padding: 5rem 10rem; border: 1px solid #e3e6f0; border-radius: 1rem;">
    ...
    <div class="form-group row" id='coordinator-group'>
        ...
        <div class="col-sm-6">
            <div class='control-group'>
                <input type='text' name='product_qty' class='form-control' value="<?php echo $product->product_qty; ?>" disabled/>
            </div>
        </div>
    </div>
    ...
    <div class="form-group row" id='coordinator-group'>
        ...
        <div class="col-sm-6">
            <div class='control-group'>
                <input type='text' name='product_price' class='form-control' value="<?php echo $product->product_price; ?>" disabled/>
            </div>
        </div>
    </div>
